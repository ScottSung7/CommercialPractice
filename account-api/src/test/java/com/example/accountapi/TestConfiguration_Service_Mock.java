...
@TestConfiguration
public class TestConfiguration_Service_Mock {
...
;
    ...
    public CustomerBalanceService customerBalanceService() {
        return new CustomerBalanceService(customerBalanceHistoryRepository, customerRepository);
    }

    @MockBean
    public CustomerBalanceHistoryRepository customerBalanceHistoryRepository;
